...
export const PREFIXES: AffixDefinition[] = [
  ...
  makeAffix('flat_physical_damage', 'prefix', 'flatPhysicalDamage', 'Brutal', ['weapon'], [
    { level: 1, min: 4, max: 11 },
    { level: 10, min: 11, max: 22 },
    { level: 25, min: 22, max: 35 },
    { level: 45, min: 35, max: 57 },
    { level: 70, min: 57, max: 84 },
  ]),
  ...
  // Armour and evasion prefixes — flat defensive stats must track monster damage
  ...
  makeAffix('flat_lightning_damage', 'prefix', 'flatLightningDamage', 'Charged', ['weapon'], [
    { level: 1, min: 2, max: 11 },
    { level: 12, min: 3, max: 20 },
    { level: 28, min: 6, max: 36 },
    { level: 48, min: 12, max: 60 },
    { level: 72, min: 20, max: 86 },
  ]),
  makeAffix('flat_cold_damage', 'prefix', 'flatColdDamage', 'Frostbound', ['weapon'], [
    { level: 1, min: 4, max: 7 },
    { level: 12, min: 7, max: 13 },
    { level: 28, min: 13, max: 24 },
    { level: 48, min: 24, max: 40 },
    { level: 72, min: 40, max: 57 },
  ]),
  makeAffix('chance_to_bleed', 'prefix', 'chanceToBleed', 'Serrated', ['weapon'], [
    { level: 1, min: 2, max: 5 },
    { level: 15, min: 5, max: 8 },
    { level: 32, min: 8, max: 12 },
    { level: 52, min: 12, max: 18 },
    { level: 75, min: 18, max: 25 },
  ]),
