...
export const PASSIVE_NODES: PassiveNode[] = [
  ...
  { id: "s_s13", type: "small", name: "", x: 747, y: -227, stats: [{ stat: "inc_movement_speed_percent", mode: "increased", value: 6 }] },
  { id: "s_s14", type: "small", name: "", x: 901, y: -211, stats: [{ stat: "inc_life_percent", mode: "increased", value: 5 }] },
  { id: "s_s2", type: "small", name: "", x: 823, y: 123, stats: [{ stat: "inc_movement_speed_percent", mode: "increased", value: 6 }] },
  ...
  { id: "s_s7", type: "small", name: "", x: 620, y: -17, stats: [{ stat: "inc_movement_speed_percent", mode: "increased", value: 6 }] },
